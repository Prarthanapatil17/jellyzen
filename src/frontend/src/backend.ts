...
export class Backend implements backendInterface {
    ...
    async getAllMeditationSessions(): Promise<Array<MeditationSessionDTO>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMeditationSessions();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getCollectibles(): Promise<Array<Collectible>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCollectibles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
